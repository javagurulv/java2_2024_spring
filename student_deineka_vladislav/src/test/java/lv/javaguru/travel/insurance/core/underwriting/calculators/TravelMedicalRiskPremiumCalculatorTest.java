...
public class TravelMedicalRiskPremiumCalculatorTest {
    ...
    public void checkPremiumCalculating() {
        ...
        when(dateTimeUtil.calculateDateFromTo(any(), any())).thenReturn(2L);
        ...
        BigDecimal premium = medicalRiskPremiumCalculator.calculatePremium(premiumRequest);
        assertEquals(premium.stripTrailingZeros(), new BigDecimal("20").stripTrailingZeros());
    }
