...
public class TravelGetAgreementControllerTestCase2
extends TravelGetAgreementControllerTestCase{
    ...
    @Override
    protected String getTestCaseFolderName(){return "internal/test_case_2";}
}
