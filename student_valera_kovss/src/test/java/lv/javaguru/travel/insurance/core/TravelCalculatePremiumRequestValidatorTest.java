...
public class TravelCalculatePremiumRequestValidatorTest {
    ...
    @Mock private ValidateAgreementDateFrom agreementDateFromValidation;
    @Mock private AgreementDateToValidation agreementDateToValidation;
    @Mock private DateFromAndDateToValidation dateFromLessThenDateToValidation;
    @Mock private AgreementDateFutureValidation agreementDateFromInFutureValidation;
