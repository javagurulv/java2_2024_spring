...
public class StructurizrStarter {
    public static void main(String[] args) throws IOException {
        ...
        File configPackage = new File("teacher/step_0/src/main/java/diagram");

        if (!configPackage.exists()) {
            throw new IOException("Configuration JSON file not found: " + configPackage.getAbsolutePath());
        }
        System.out.println("Configuration JSON file was found: " + configPackage.getAbsolutePath());
