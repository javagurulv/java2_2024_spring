workspace {
    ...
    model {
        ...
        group "Insurance Application" {
            ...
            jobs = softwareSystem "JOBS" {
                description "Performs a scheduled task"
                jobsComponent = container "JOBS component" {
                    tags "container"
                    xmlExporter = component "AgreementXmlExporterJob" {
                        tags "xmlExporter"
                        description "Performs a scheduled task"
                    }
                    AgreementXmlExporter = component "AgreementXmlExporter" {
                        tags "AgreementXmlExporter"
                    }
                }
            }
            ...
            database = softwaresystem "DataBase" "mySQL" {
                ...
                tables = container "Database tables" {
                    ...
                    travel_cancellation_age_coefficient = component "travel_cancellation_age_coefficient" {
                        description "Contains id, age_from, age_to, coefficient\n - Coefficient table based on age ranges for travel cancellation."
                    }
                    travel_cancellation_country_safety_rating = component "travel_cancellation_country_safety_rating" {
                        description "Contains id, country_ic, coefficient\n - Coefficient table based on country safety ratings."
                    }
                    agreements_xml_export = component "agreements_xml_export" {
                        description "Contains id, agreement_uuid, already_exported (BOOL)"
                    }
                }
            }
        }
    ...
    views {
        ...
        component jobsComponent "JOBS_view" {
            include *
            autolayout lr
        }
