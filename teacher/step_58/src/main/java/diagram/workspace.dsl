workspace {
    ...
    model {
        ...
        group "Insurance Application" {
            ...
            ss = softwareSystem "Web Application" "Spring Web Java" {
                ...
                core = container "CORE" "Manages HTTP requests/responses, session data, and provides foundational interfaces for extending web functionalities." {
                    ...
                    errorCodeUtil = component "ErrorCodeUtil" {
                        description "Provides error descriptions based on error codes."
                    }
                }
        ...
        service -> errorCodeUtil "Uses for error descriptions"
        errorCodeUtil -> errorCodes "Loads error codes to memory"
